...
export default class extends Component {
  ...
  static defaultProps = {
    ...
    displayArea: new Rect(
      0,
      material.toolbarHeight,
      SCREEN_WIDTH,
      SCREEN_HEIGHT - material.toolbarHeight - material.footerHeight
    ),
  ...
  getArrowDynamicStyle() {
    ...
    return {
      ...
      top:
        ...
        popoverOrigin.y -
        height / 2 +
        (this.getPlacement() === 'bottom' && material.platform === 'android'
          ? padding
          : 0),
      width,
      height,
  ...
  render() {
    ...
    const arrowTransform = (StyleSheet.flatten(arrowStyle).transform || [])
      .slice(0);
    ...
    return (
      <TouchableWithoutFeedback onPress={e => this.close()}>
        <View
          style={[
            styles.container,
        ...
        >
          ...
          >
            <Animated.View
              style={[...arrowStyle, { transform: arrowTransform }]}
            />
